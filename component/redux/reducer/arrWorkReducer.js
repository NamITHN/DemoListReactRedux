...
const defaultArrayWork=[ {id:1, en:'action', vn:'hành động', memorized:true, isShow:false },
...
const arrWorkReducer = (state = defaultArrayWork, action) =>  {
    if (action.type === 'MEMORIED'){
      return state.map(e=>{
